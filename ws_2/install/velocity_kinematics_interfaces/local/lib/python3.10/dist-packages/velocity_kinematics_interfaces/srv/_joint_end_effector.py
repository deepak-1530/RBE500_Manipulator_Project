...
class Metaclass_JointEndEffector_Request(type):
    """Metaclass of message 'JointEndEffector_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__joint_end_effector__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__joint_end_effector__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__joint_end_effector__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__joint_end_effector__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__joint_end_effector__request
...
class JointEndEffector_Request(metaclass=Metaclass_JointEndEffector_Request):
    """Message class 'JointEndEffector_Request'."""
...
class Metaclass_JointEndEffector_Response(type):
    """Metaclass of message 'JointEndEffector_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__joint_end_effector__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__joint_end_effector__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__joint_end_effector__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__joint_end_effector__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__joint_end_effector__response
...
class JointEndEffector_Response(metaclass=Metaclass_JointEndEffector_Response):
    """Message class 'JointEndEffector_Response'."""
...
class Metaclass_JointEndEffector(type):
    """Metaclass of service 'JointEndEffector'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'velocity_kinematics_interfaces.srv.JointEndEffector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__joint_end_effector

            from velocity_kinematics_interfaces.srv import _joint_end_effector
            if _joint_end_effector.Metaclass_JointEndEffector_Request._TYPE_SUPPORT is None:
                _joint_end_effector.Metaclass_JointEndEffector_Request.__import_type_support__()
            if _joint_end_effector.Metaclass_JointEndEffector_Response._TYPE_SUPPORT is None:
                _joint_end_effector.Metaclass_JointEndEffector_Response.__import_type_support__()


class JointEndEffector(metaclass=Metaclass_JointEndEffector):
    from velocity_kinematics_interfaces.srv._joint_end_effector import JointEndEffector_Request as Request
    from velocity_kinematics_interfaces.srv._joint_end_effector import JointEndEffector_Response as Response
