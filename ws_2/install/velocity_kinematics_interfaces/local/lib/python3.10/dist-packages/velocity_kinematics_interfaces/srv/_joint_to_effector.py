...
class Metaclass_JointToEffector_Request(type):
    """Metaclass of message 'JointToEffector_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__joint_to_effector__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__joint_to_effector__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__joint_to_effector__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__joint_to_effector__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__joint_to_effector__request
...
class JointToEffector_Request(metaclass=Metaclass_JointToEffector_Request):
    """Message class 'JointToEffector_Request'."""
...
class Metaclass_JointToEffector_Response(type):
    """Metaclass of message 'JointToEffector_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__joint_to_effector__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__joint_to_effector__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__joint_to_effector__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__joint_to_effector__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__joint_to_effector__response
...
class JointToEffector_Response(metaclass=Metaclass_JointToEffector_Response):
    """Message class 'JointToEffector_Response'."""
...
class Metaclass_JointToEffector(type):
    """Metaclass of service 'JointToEffector'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'velocity_kinematics_interfaces.srv.JointToEffector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__joint_to_effector

            from velocity_kinematics_interfaces.srv import _joint_to_effector
            if _joint_to_effector.Metaclass_JointToEffector_Request._TYPE_SUPPORT is None:
                _joint_to_effector.Metaclass_JointToEffector_Request.__import_type_support__()
            if _joint_to_effector.Metaclass_JointToEffector_Response._TYPE_SUPPORT is None:
                _joint_to_effector.Metaclass_JointToEffector_Response.__import_type_support__()


class JointToEffector(metaclass=Metaclass_JointToEffector):
    from velocity_kinematics_interfaces.srv._joint_to_effector import JointToEffector_Request as Request
    from velocity_kinematics_interfaces.srv._joint_to_effector import JointToEffector_Response as Response
