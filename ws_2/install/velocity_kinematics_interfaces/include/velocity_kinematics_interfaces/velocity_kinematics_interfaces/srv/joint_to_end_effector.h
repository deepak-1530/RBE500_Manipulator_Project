...
#ifndef VELOCITY_KINEMATICS_INTERFACES__SRV__JOINT_TO_END_EFFECTOR_H_
#define VELOCITY_KINEMATICS_INTERFACES__SRV__JOINT_TO_END_EFFECTOR_H_
...
#endif  // VELOCITY_KINEMATICS_INTERFACES__SRV__JOINT_TO_END_EFFECTOR_H_
