...
velocity_kinematics_interfaces__srv__JointEndEffector_Request__create()
{
  ...
  velocity_kinematics_interfaces__srv__JointEndEffector_Request * msg = (velocity_kinematics_interfaces__srv__JointEndEffector_Request *)allocator.allocate(sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Request));
  bool success = velocity_kinematics_interfaces__srv__JointEndEffector_Request__init(msg);
  if (!success) {
...
velocity_kinematics_interfaces__srv__JointEndEffector_Request__destroy(velocity_kinematics_interfaces__srv__JointEndEffector_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    velocity_kinematics_interfaces__srv__JointEndEffector_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence__init(velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  velocity_kinematics_interfaces__srv__JointEndEffector_Request * data = NULL;

  if (size) {
    data = (velocity_kinematics_interfaces__srv__JointEndEffector_Request *)allocator.zero_allocate(size, sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = velocity_kinematics_interfaces__srv__JointEndEffector_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        velocity_kinematics_interfaces__srv__JointEndEffector_Request__fini(&data[i - 1]);
      }
...
velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence__fini(velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      velocity_kinematics_interfaces__srv__JointEndEffector_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence * array = (velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence *)allocator.allocate(sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence__init(array, size);
  if (!success) {
...
velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence__destroy(velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence__are_equal(const velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence * lhs, const velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!velocity_kinematics_interfaces__srv__JointEndEffector_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  velocity_kinematics_interfaces__srv__JointEndEffector_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    velocity_kinematics_interfaces__srv__JointEndEffector_Request * data =
      (velocity_kinematics_interfaces__srv__JointEndEffector_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!velocity_kinematics_interfaces__srv__JointEndEffector_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          velocity_kinematics_interfaces__srv__JointEndEffector_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!velocity_kinematics_interfaces__srv__JointEndEffector_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  velocity_kinematics_interfaces__srv__JointEndEffector_Response * msg = (velocity_kinematics_interfaces__srv__JointEndEffector_Response *)allocator.allocate(sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Response));
  bool success = velocity_kinematics_interfaces__srv__JointEndEffector_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
velocity_kinematics_interfaces__srv__JointEndEffector_Response__destroy(velocity_kinematics_interfaces__srv__JointEndEffector_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    velocity_kinematics_interfaces__srv__JointEndEffector_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence__init(velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  velocity_kinematics_interfaces__srv__JointEndEffector_Response * data = NULL;

  if (size) {
    data = (velocity_kinematics_interfaces__srv__JointEndEffector_Response *)allocator.zero_allocate(size, sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = velocity_kinematics_interfaces__srv__JointEndEffector_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        velocity_kinematics_interfaces__srv__JointEndEffector_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence__fini(velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      velocity_kinematics_interfaces__srv__JointEndEffector_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence * array = (velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence *)allocator.allocate(sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence__destroy(velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence__are_equal(const velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence * lhs, const velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!velocity_kinematics_interfaces__srv__JointEndEffector_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  velocity_kinematics_interfaces__srv__JointEndEffector_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(velocity_kinematics_interfaces__srv__JointEndEffector_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    velocity_kinematics_interfaces__srv__JointEndEffector_Response * data =
      (velocity_kinematics_interfaces__srv__JointEndEffector_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!velocity_kinematics_interfaces__srv__JointEndEffector_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          velocity_kinematics_interfaces__srv__JointEndEffector_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!velocity_kinematics_interfaces__srv__JointEndEffector_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
