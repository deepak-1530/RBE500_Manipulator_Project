...
bool velocity_kinematics_interfaces__msg__end_effector_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_kinematics_interfaces.msg._end_effector_velocity.EndEffectorVelocity", full_classname_dest, 77) == 0);
  }
  velocity_kinematics_interfaces__msg__EndEffectorVelocity * ros_message = _ros_message;
  {  // vx
...
{
  /* NOTE(esteve): Call constructor of EndEffectorVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_kinematics_interfaces.msg._end_effector_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EndEffectorVelocity");
