...
bool velocity_kinematics_interfaces__srv__end_effector_to_joint__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_kinematics_interfaces.srv._end_effector_to_joint.EndEffectorToJoint_Request", full_classname_dest, 84) == 0);
  }
  velocity_kinematics_interfaces__srv__EndEffectorToJoint_Request * ros_message = _ros_message;
  {  // vx
...
{
  /* NOTE(esteve): Call constructor of EndEffectorToJoint_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_kinematics_interfaces.srv._end_effector_to_joint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EndEffectorToJoint_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool velocity_kinematics_interfaces__srv__end_effector_to_joint__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_kinematics_interfaces.srv._end_effector_to_joint.EndEffectorToJoint_Response", full_classname_dest, 85) == 0);
  }
  velocity_kinematics_interfaces__srv__EndEffectorToJoint_Response * ros_message = _ros_message;
  {  // joint_vel1
...
{
  /* NOTE(esteve): Call constructor of EndEffectorToJoint_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_kinematics_interfaces.srv._end_effector_to_joint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EndEffectorToJoint_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
