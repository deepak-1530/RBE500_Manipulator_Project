...
bool velocity_kinematics_interfaces__srv__joint_to_end_effector__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_kinematics_interfaces.srv._joint_to_end_effector.JointToEndEffector_Request", full_classname_dest, 84) == 0);
  }
  velocity_kinematics_interfaces__srv__JointToEndEffector_Request * ros_message = _ros_message;
  {  // joint_vel1
...
{
  /* NOTE(esteve): Call constructor of JointToEndEffector_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_kinematics_interfaces.srv._joint_to_end_effector");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointToEndEffector_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool velocity_kinematics_interfaces__srv__joint_to_end_effector__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_kinematics_interfaces.srv._joint_to_end_effector.JointToEndEffector_Response", full_classname_dest, 85) == 0);
  }
  velocity_kinematics_interfaces__srv__JointToEndEffector_Response * ros_message = _ros_message;
  {  // vx
...
{
  /* NOTE(esteve): Call constructor of JointToEndEffector_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_kinematics_interfaces.srv._joint_to_end_effector");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointToEndEffector_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
