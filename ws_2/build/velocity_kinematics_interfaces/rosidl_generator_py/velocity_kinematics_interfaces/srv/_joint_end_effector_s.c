...
bool velocity_kinematics_interfaces__srv__joint_end_effector__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_kinematics_interfaces.srv._joint_end_effector.JointEndEffector_Request", full_classname_dest, 79) == 0);
  }
  velocity_kinematics_interfaces__srv__JointEndEffector_Request * ros_message = _ros_message;
  {  // joint_vel1
...
{
  /* NOTE(esteve): Call constructor of JointEndEffector_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_kinematics_interfaces.srv._joint_end_effector");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointEndEffector_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool velocity_kinematics_interfaces__srv__joint_end_effector__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_kinematics_interfaces.srv._joint_end_effector.JointEndEffector_Response", full_classname_dest, 80) == 0);
  }
  velocity_kinematics_interfaces__srv__JointEndEffector_Response * ros_message = _ros_message;
  {  // vx
...
{
  /* NOTE(esteve): Call constructor of JointEndEffector_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_kinematics_interfaces.srv._joint_end_effector");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointEndEffector_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
