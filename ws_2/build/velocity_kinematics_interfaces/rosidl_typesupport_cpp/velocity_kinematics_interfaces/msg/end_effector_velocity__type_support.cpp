...
static const _EndEffectorVelocity_type_support_symbol_names_t _EndEffectorVelocity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, velocity_kinematics_interfaces, msg, EndEffectorVelocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, velocity_kinematics_interfaces, msg, EndEffectorVelocity)),
  }
};
...
{
  return &::velocity_kinematics_interfaces::msg::rosidl_typesupport_cpp::EndEffectorVelocity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, velocity_kinematics_interfaces, msg, EndEffectorVelocity)() {
  return get_message_type_support_handle<velocity_kinematics_interfaces::msg::EndEffectorVelocity>();
}
